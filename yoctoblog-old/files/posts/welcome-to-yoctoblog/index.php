	<?php
	$title = 'Welcome to Yoctoblog!';
	$post = '<p>At creation, you have a user called \"admin\", whose password is \"root\". You need to go change that RIGHT NOW. Go.</p>
